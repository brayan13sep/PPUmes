...
START TRANSACTION;
USE `hospital`;
INSERT INTO `hospital`.`Tipo_Documento` (`ID`, `descripcion`, `activo`, `timestamp`) VALUES (1, 'DPI', 1, '2016-09-29 19:51:00');
INSERT INTO `hospital`.`Tipo_Documento` (`ID`, `descripcion`, `activo`, `timestamp`) VALUES (2, 'CEDULA', 1, '2016-09-29 19:51:00');
INSERT INTO `hospital`.`Tipo_Documento` (`ID`, `descripcion`, `activo`, `timestamp`) VALUES (3, 'PASAPORTE', 1, '2016-09-29 19:51:00');
...
START TRANSACTION;
USE `hospital`;
INSERT INTO `hospital`.`Estado_Civil` (`ID`, `descripcion`, `activo`, `timestamp`) VALUES (1, 'SOLTERO(A)', 1, '2016-09-29 19:51:00');
INSERT INTO `hospital`.`Estado_Civil` (`ID`, `descripcion`, `activo`, `timestamp`) VALUES (2, 'CASADO(A)', 1, '2016-09-29 19:51:00');
...
START TRANSACTION;
USE `hospital`;
INSERT INTO `hospital`.`Nivel_Educativo` (`ID`, `descripcion`, `activo`, `timestamp`) VALUES (1, 'PRIMARIA', 1, '2016-09-29 19:51:00');
INSERT INTO `hospital`.`Nivel_Educativo` (`ID`, `descripcion`, `activo`, `timestamp`) VALUES (2, 'EDUCACION BASICA', 1, '2016-09-29 19:51:00');
INSERT INTO `hospital`.`Nivel_Educativo` (`ID`, `descripcion`, `activo`, `timestamp`) VALUES (3, 'DIVERSIFICADO', 1, '2016-09-29 19:51:00');
INSERT INTO `hospital`.`Nivel_Educativo` (`ID`, `descripcion`, `activo`, `timestamp`) VALUES (4, 'CARRERA UNIVERSITARIA', 1, '2016-09-29 19:51:00');
...
START TRANSACTION;
USE `hospital`;
INSERT INTO `hospital`.`Sede` (`ID`, `nombre`, `direccion`, `departamento`, `municipio`, `zona`, `activo`, `timestamp`) VALUES (1, 'HOSPITAL DE AMATITLAN', '4TA CALLE 10 AVE BARRIO HOSPITAL AMATITLAN', 'GUATEMALA', 'AMATITLAN', '0', 1, '2016-09-29 19:51:00');
...
START TRANSACTION;
USE `hospital`;
INSERT INTO `hospital`.`Atendio_Parto` (`ID`, `descripcion`, `activo`, `timestamp`) VALUES (1, 'ENFERMERO(A)', 1, '2016-09-29 19:51:00');
INSERT INTO `hospital`.`Atendio_Parto` (`ID`, `descripcion`, `activo`, `timestamp`) VALUES (2, 'MEDICO GENERAL', 1, '2016-09-29 19:51:00');
INSERT INTO `hospital`.`Atendio_Parto` (`ID`, `descripcion`, `activo`, `timestamp`) VALUES (3, 'MEDICO GINECO-OBSTETRA', 1, '2016-09-29 19:51:00');
INSERT INTO `hospital`.`Atendio_Parto` (`ID`, `descripcion`, `activo`, `timestamp`) VALUES (4, 'OBSTETRA', 1, '2016-09-29 19:51:00');
...
START TRANSACTION;
USE `hospital`;
INSERT INTO `hospital`.`Condicion_Parto` (`ID`, `descripcion`, `activo`, `timestamp`) VALUES (1, 'ESPONTANEO', 1, '2016-09-29 19:51:00');
INSERT INTO `hospital`.`Condicion_Parto` (`ID`, `descripcion`, `activo`, `timestamp`) VALUES (2, 'INSTRUMENTADO', 1, '2016-09-29 19:51:00');
INSERT INTO `hospital`.`Condicion_Parto` (`ID`, `descripcion`, `activo`, `timestamp`) VALUES (3, 'CESAREA', 1, '2016-09-29 19:51:00');
...
START TRANSACTION;
USE `hospital`;
INSERT INTO `hospital`.`Tipo_Parto` (`ID`, `descripcion`, `activo`, `timestamp`) VALUES (1, 'UNICO', 1, '2016-09-29 19:51:00');
INSERT INTO `hospital`.`Tipo_Parto` (`ID`, `descripcion`, `activo`, `timestamp`) VALUES (2, 'DOBLE', 1, '2016-09-29 19:51:00');
INSERT INTO `hospital`.`Tipo_Parto` (`ID`, `descripcion`, `activo`, `timestamp`) VALUES (3, 'TRIPLE', 1, '2016-09-29 19:51:00');
INSERT INTO `hospital`.`Tipo_Parto` (`ID`, `descripcion`, `activo`, `timestamp`) VALUES (4, 'MAS DE TRES', 1, '2016-09-29 19:51:00');
...
START TRANSACTION;
USE `hospital`;
INSERT INTO `hospital`.`Profesion` (`ID`, `descripcion`, `activo`, `timestamp`) VALUES (1, 'OBSTETRA', 1, '2016-09-29 19:21:00');
INSERT INTO `hospital`.`Profesion` (`ID`, `descripcion`, `activo`, `timestamp`) VALUES (2, 'MEDICO GENERAL', 1, '2016-09-29 19:21:00');
...
START TRANSACTION;
USE `hospital`;
INSERT INTO `hospital`.`Usuario` (`ID`, `usuario`, `password`, `activo`, `timestamp`, `token`) VALUES (1, 'admin', 'admin', 1, '2016-09-29 19:51:00', NULL);
INSERT INTO `hospital`.`Usuario` (`ID`, `usuario`, `password`, `activo`, `timestamp`, `token`) VALUES (2, 'enfermero', 'enfermero', 1, '2016-09-29 19:51:00', NULL);
...
START TRANSACTION;
USE `hospital`;
INSERT INTO `hospital`.`Role` (`ID`, `role`, `descripcion`, `activo`, `timestamp`) VALUES (1, 'DOCTOR', NULL, 1, '2016-09-29 19:51:00');
INSERT INTO `hospital`.`Role` (`ID`, `role`, `descripcion`, `activo`, `timestamp`) VALUES (2, 'ENFERMERO', 'DEBE LLENAR SOLO FORMULARIOS', 1, '2016-09-29 19:51:00');
INSERT INTO `hospital`.`Role` (`ID`, `role`, `descripcion`, `activo`, `timestamp`) VALUES (3, 'DIRECTOR', '', 1, '2016-09-29 19:51:00');
INSERT INTO `hospital`.`Role` (`ID`, `role`, `descripcion`, `activo`, `timestamp`) VALUES (4, 'ADMIN', NULL, 1, '2016-09-29 19:51:00');
INSERT INTO `hospital`.`Role` (`ID`, `role`, `descripcion`, `activo`, `timestamp`) VALUES (5, 'DBA', NULL, 1, '2016-09-29 19:51:00');
