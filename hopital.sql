...
-- -----------------------------------------------------
-- Table `hospital`.`madre_neonato`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `hospital`.`madre_neonato` ;

CREATE TABLE IF NOT EXISTS `hospital`.`madre_neonato` (
  `Madre_ID` INT NOT NULL,
  `Madre_rfid` VARCHAR(255) NOT NULL,
  `Neonato_ID` INT NOT NULL,
  `Neonato_rfid` VARCHAR(255) NOT NULL,
  PRIMARY KEY (`Madre_ID`, `Madre_rfid`),
  INDEX `fk_madre_neonato_Madre1_idx` (`Madre_ID` ASC, `Madre_rfid` ASC),
  INDEX `fk_madre_neonato_Neonato1_idx` (`Neonato_ID` ASC, `Neonato_rfid` ASC),
  CONSTRAINT `fk_madre_neonato_Madre1`
    FOREIGN KEY (`Madre_ID` , `Madre_rfid`)
    REFERENCES `hospital`.`Madre` (`ID` , `rfid`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_madre_neonato_Neonato1`
